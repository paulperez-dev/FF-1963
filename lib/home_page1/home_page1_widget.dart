import '/components/modal_example_widget.dart';
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      await launchURL('https://www.wikipedia.org/');
                    },
                    child: BarcodeWidget(
                      data: 'Barcode',
                  ...
                  onPressed: () async {
                    await showDialog(
                      ...
                      builder: (alertDialogContext) {
                        return WebViewAware(
                          child: AlertDialog(
                            title: Text('You are using our latest version'),
                            actions: [
                              TextButton(
                                onPressed: () =>
                                    Navigator.pop(alertDialogContext),
                                child: Text('Keep building'),
                              ),
                            ],
                          ),
                        );
